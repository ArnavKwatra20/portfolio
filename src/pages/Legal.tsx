export function Legal({ kind }: { kind: 'privacy' | 'terms' }) {
  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-14 sm:px-8 md:py-20">
      ...
      <p className="font-mono-x mt-8 text-[12px] uppercase tracking-[0.2em] text-[#7c7263]">
        {isPrivacy ? 'Privacy / updated 2026' : 'Terms / updated 2026'}
      </p>
      <h1 className="font-display mt-4 text-4xl font-medium tracking-tight text-[#1b1814] md:text-5xl">
        {isPrivacy ? 'What this site collects.' : 'How this site may be used.'}
      </h1>
      <div className="mt-8 space-y-8 border-t border-[#1b1814] pt-8 text-[15px] leading-7 text-[#4d463c]">
        {isPrivacy ? (
          <>
            <section>
              <h2 className="font-display text-xl text-[#1b1814]">Contact form</h2>
            ...
            <section>
              <h2 className="font-display text-xl text-[#1b1814]">External links</h2>
            ...
            <section>
              <h2 className="font-display text-xl text-[#1b1814]">Analytics</h2>
          ...
          <>
            <section>
              <h2 className="font-display text-xl text-[#1b1814]">Content</h2>
            ...
            <section>
              <h2 className="font-display text-xl text-[#1b1814]">Concept work</h2>
            ...
            <section>
              <h2 className="font-display text-xl text-[#1b1814]">Contact</h2>
